						...
						{project.tags &&
							project.tags.map((tag, i) => {
								return (
									<p
										key={i}
										className="inline-block px-4 py-1 mx-1 my-1 text-sm text-center transition-colors ease-in-out border-2 cursor-default sm:text-base whitespace-nowrap border-darkBlueSemiTrans bg-blue-400/10 hover:bg-blue-400/0 text-darkBlue drop-shadow-md rounded-2xl"
									>
										{tag.toString()}
									</p>
								);
