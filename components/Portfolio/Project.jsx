						...
						{project.tags &&
							project.tags.map((tag, i) => {
								return (
									<p
										key={i}
										className="inline-block px-2 py-1 mx-1 my-1 text-center transition-colors ease-in-out border-2 cursor-default md:py-2 md:px-4 border-darkBlueSemiTrans bg-blue-400/10 hover:bg-blue-400/0 text-darkBlue drop-shadow-md rounded-2xl"
									>
										{tag.toString()}
									</p>
								);
